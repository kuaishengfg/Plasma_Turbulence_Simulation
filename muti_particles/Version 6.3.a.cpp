...
//int totalnumber = 1000000, testnumber = 9;
...
//R0 :outer edge
//Rm :inner edge
long double sita [totalnumber], r [totalnumber], r1 [totalnumber] [testnumber], r2 [totalnumber] [testnumber], MT [totalnumber] [5], flux[3] [testnumber];
...
int hh = hhh + 1;
//In fact, hh = 1 / h, here is difference between accurate number and computed number exsisted
long double deltar, deltasita, crashr, crashsita;
//delta_r,delta_sita,crash_r,crash_sita
long double Rr, T;
//Rr   :test nodes
//T    :all sport time   
...
void RK (long double sitax, long double rx, long double tx){
...
//Version 6.2.x 2024.7.6
//Version 6.3.a 2024.7.7
